...
<h1>Kirish rad etildi. Ma'lumot uchun Adminga murojaat qiling</h1>
<form action="{{ route('logout') }}" method="post">
    @csrf
    <button class="shopping-cart-footer shopping-cart-button outline" style="cursor: pointer!important;background-color: transparent !important;color: #ca3c3c !important;border: none !important; font-size: 25px" href="{{ route('logout') }}" onclick="return confirm('Chiqishni Tasdiqlang')">Akkauntdan Chiqish</button>
</form>
<script>
